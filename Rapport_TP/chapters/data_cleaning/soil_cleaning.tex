...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{images/Soil/soil_parallel_coordinates_texture.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{images/Soil/soil_ORG_CARBON_per_TOTAL_N_vs_CN_RATIO_scatter_qq.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{images/Soil/soil_CEC_SOIL_per_CLAY_vs_CEC_CLAY_scatter_qq.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{images/Soil/soil_TEB_per_CEC_EFF_vs_BSAT_scatter_qq.png}
