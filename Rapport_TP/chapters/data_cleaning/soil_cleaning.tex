...
Figure~\ref{fig:soil-maps-numeric} illustrates these spatial patterns and confirms the expected geographic heterogeneity of soil properties across the study area.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/Soil/soil_maps_numeric_variation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.42\textwidth]{images/Soil/soil_kde_ref_bulk}
    \hspace{0.05\textwidth}
    \includegraphics[width=0.42\textwidth]{images/Soil/soil_kde_ref_bulk_after_imputation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.42\textwidth]{images/Soil/soil_hist_texture_usda}
    \hspace{0.05\textwidth}
    \includegraphics[width=0.42\textwidth]{images/Soil/soil_hist_texture_usda_after_imputer}
...
To assess whether these invalid records were spatially localized or randomly distributed, their geographic distribution was visualized. The soil dataset was converted into a GeoDataFrame using longitude and latitude coordinates, and a spatial scatter map was generated. Valid observations were displayed in light gray, while invalid observations were highlighted in blue (Figure~\ref{fig:invalid_spatial}). This visualization made it possible to evaluate spatial clustering patterns and informed the choice of a spatially aware imputation strategy.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/Soil/soil_invalid_negative_spatial_distribution.png}
    \caption{Spatial distribution of invalid soil records with negative values. Valid points are shown in light gray, while invalid points (all key soil properties negative) are highlighted in blue.}\label{fig:invalid_spatial}
\end{figure}
...
\begin{enumerate}
    ...
    \item \textbf{Construction of a BallTree}: A BallTree data structure was built using only valid soil records, with the haversine distance metric. This structure enables efficient spatial nearest-neighbor searches.
...
\subsubsection{BallTree Algorithm in the Context of Soil Data}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/Soil/soil_maps_numeric_variation_after_invalid_imputation}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/Soil/soil_kde_all_after_imputation.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/Soil/soil_qq_numeric_after_imputation.png}
...
\begin{tabular}{lr}
\toprule
\textbf{Variable} & \textbf{Outlier Count} \\
\midrule
COARSE & 28 \\
SAND & 12 \\
SILT & 0 \\
...
\bottomrule
\end{tabular}
\caption{Count of statistical outliers detected by IQR-based method after imputation.}\label{tab:outlier_counts}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/Soil/soil_parallel_coordinates_texture.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/Soil/soil_ORG_CARBON_per_TOTAL_N_vs_CN_RATIO_scatter_qq.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/Soil/soil_CEC_SOIL_per_CLAY_vs_CEC_CLAY_scatter_qq.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/Soil/soil_TEB_per_CEC_EFF_vs_BSAT_scatter_qq.png}
