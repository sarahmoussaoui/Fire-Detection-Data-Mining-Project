...
\begin{itemize}
    ...
    \item \textbf{Missing Values:} A check across all columns confirmed the absence of any null/NAN values, indicating completeness.
\end{itemize}
...
\begin{itemize}    
    ...
    \begin{figure} [H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/LandCover/Land Cover Types - Algeria and Tunisia Merged.png}
...
\end{figure}
    ...
    \item \textbf{Area Analysis:} The geometric area of each polygon was calculated. A bar plot was generated showing the Total Area by Land Cover Code.


    \begin{figure} [H]
        \centering
        \includegraphics[width=0.35\textwidth]{images/LandCover/total area by lcc code bar chart.png}
    ...
    \end{figure}
\end{itemize}
In the land cover plot, the classes coded as \textbf{6004}, \textbf{6001}, and \textbf{0011}, which correspond to \textbf{bare land}, occupy the largest proportion of the study area.
