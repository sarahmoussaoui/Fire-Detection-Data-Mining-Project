...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/Soil/soil_hist_numeric_annotated}
    \caption{Histograms of soil numeric variables with mean, median and mode indicators.}\label{fig:soil-histograms}
\end{figure}

\subsection{Normality assessment using quantiles plots}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/Soil/soil_qq_numeric}
