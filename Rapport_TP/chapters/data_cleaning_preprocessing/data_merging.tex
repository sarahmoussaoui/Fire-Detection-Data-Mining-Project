...
First, the fire dataset was prepared by keeping only essential columns: longitude, latitude, and a binary \texttt{fire} column (1 indicating a fire event, 0 otherwise). 
This dataset was then merged with the land cover dataset using a spatial join based on geographic location. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/MergedDatasets/fire_events per geographical cell.png}
    \caption{Distribution of fire events aggregated per $0.1^\circ \times 0.1^\circ$ geographical grid cell}
\end{figure}


\subsection{After Merging Climate, Soil, and Elevation Data}

After merging the climate, soil, and elevation datasets, several important changes were made to the structure of the dataset:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{images/MergedDatasets/climate_soil_coverage.png}
