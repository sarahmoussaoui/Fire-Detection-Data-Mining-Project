...
Inertia & $2.79 \times 10^{9}$ & $6.63 \times 10^{8}$ \\
Silhouette score & 0.7148 & 0.5991 \\
Davies--Bouldin index & 0.2921 & 0.4907 \\
Calinski--Harabasz index & $2.81 \times 10^{6}$ & $3.38 \times 10^{6}$ \\
...
Visualizations of the clustering results for both implementations are provided in Annex~\ref{annexe:kmeans_visualizations}.