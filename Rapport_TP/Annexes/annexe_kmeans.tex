...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/Kmeans/kmeans_bayesian_optimization.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/Kmeans/kmeans_visualization_from_scratch.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/Kmeans/sklearn_kmeans_visualization.png}
