...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/Soil/soil_maps_numeric_variation}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{images/Soil/soil_kde_all_after_imputation.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{images/Soil/soil_qq_numeric_after_imputation.png}
